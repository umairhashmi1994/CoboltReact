...
class Banner extends React.Component {
    render() {
      return (
          ...
          style={{ backgroundImage: "url(/images/ecommerceBanner.jpg)" }}
        >
                ...
                <div className="uk-width-3-5@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>Transformative Digital Experiences That Drive Revenue</h1>
                      <p>Our infrastructure helps you build a secure and scalable e-commerce platform that meets the need of both your customers and the business. </p>
