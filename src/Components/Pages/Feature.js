...
class Feature extends React.Component {
    render() {
      ...
      return (
          <div>
            <section className="feature pattarntopleft">
                ...
                <div className="" uk-grid="">
                    <div className="uk-width-2-5@l uk-width-1-2@m" >
                        <div className="featurecontentleft">
                            <hr/>
                            <h1>Features</h1>
                            <a className="featurebtn" href="#">See more 
                            <img src="/images/downicon.svg" uk-svg="" hidden=""/>
                            </a>
                        </div>
                    </div>
                <div className="uk-width-3-5@l uk-width-1-2@m">
                    <div className="" uk-grid="">
