...
class Banner extends React.Component {
    render() {
      return (
          <div>
              <section
          className="HomeBannerThree"
          style={{ backgroundImage: "url(/images/baBanner2.jpg)" }}
        >
            ...
            <div className="uk-container uk-container-expand containerCustom">
              <div uk-grid="">
                <div className="uk-width-3-5@m uk-width-1-2@s">
                  <div className="mdl">
                    <div className="mdlinner bannerthree">
                      <h1>Keep Your Data Protected With Cobolt’s Backups</h1>
                      <p>Our backup service ensures your data is always available and safe</p>
                      </div>
                    </div>
                </div>
