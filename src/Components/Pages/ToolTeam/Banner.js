...
class Banner extends React.Component {
    render() {
      return (
          ...
          style={{ backgroundImage: "url(/images/toolteamBanner.png)" }}
        >
                ...
                <div className="uk-width-3-5@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>Collaborate On Cobolt & Accelerate Your Business </h1>
                      <p>Collaborate securely and efficiently on projects with unlimited members & optimize your projects. Ensure secure access to your projects using 2FA for multiple team members. </p>
