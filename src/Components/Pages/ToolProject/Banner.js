...
class Banner extends React.Component {
    render() {
      return (
          ...
          style={{ backgroundImage: "url(/images/toolProjectBanner.png)" }}
        >
                ...
                <div className="uk-width-3-5@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>All Your Resources Sorted!</h1>
                      <p>Projects act as a tool to organize all of your infrastructure resources such as atoms, spaces and load balancers into groups according to your business requirements. </p>
