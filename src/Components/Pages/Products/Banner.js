                ...
                <div className="uk-width-1-2@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      ...
                      <p>Use the managed Cobolt platform to design, build, launch and scale your applications quickly. With just a few clicks, you can spin up your magic while we handle your infrastructure and everything else.</p>
