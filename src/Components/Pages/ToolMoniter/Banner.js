...
class Banner extends React.Component {
    render() {
      return (
          ...
          style={{ backgroundImage: "url(/images/webBanner.png)" }}
        >
                ...
                <div className="uk-width-1-1@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo text-center uk-align-center">
                      <h1>Monitor Your Infrastructure <br/>Metrics In One Place </h1>
                      <p>Easily analyze and monitor Atom performance using graphs, and receive alerts to keep track of your infrastructure usage.</p>
                      <a className="webBanbtn" href="#">Get Started Now</a>
                      </div>
                    </div>
                </div>
