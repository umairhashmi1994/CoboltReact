...
class Banner extends React.Component {
    render() {
      return (
          <div>
              <section
          className="HomeBannerTwo loadbalanceBanner"
          style={{ backgroundImage: "url(/images/networkLoadBalanceBanner.jpg)" }}
        >
                ...
                <div className="uk-width-3-5@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>Scale Your Applications As Needed</h1>
                      <p>Cobolt’s load balancers provide you the ability to easily scale your application or website according to the needs of the business thus increasing your reliability and performance</p>
