...
class Banner extends React.Component {
    render() {
      return (
          ...
          style={{ backgroundImage: "url(/images/ToolSupportBanner.png)" }}
        >
                ...
                <div className="uk-width-1-2@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>Experience The Best-In-Class Support</h1>
                      <p>Three tier support system catering to all your queries and giving you complete peace of mind. </p>
