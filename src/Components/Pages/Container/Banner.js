...
class Banner extends React.Component {
    render() {
      return (
          ...
          style={{ backgroundImage: "url(/images/containerBanner.jpg)" }}
        >
                ...
                <div className="uk-width-2-3@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>Container Services<br/> For Developers </h1>
                      <p>A minimalist environment for the user that allows secure storage of containers along with enabling seamless app deployment across various environments.</p>
