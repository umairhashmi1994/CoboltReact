...
class Banner extends React.Component {
    render() {
      return (
          ...
          style={{ backgroundImage: "url(/images/networkVpc.png)" }}
        >
                ...
                <div className="uk-width-3-5@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>Keep Your Resources Secure Within Private Networks </h1>
                      <p>Gain complete control over your virtual networking environment to keep your resources secure and have the ability to customize your network configuration. </p>
