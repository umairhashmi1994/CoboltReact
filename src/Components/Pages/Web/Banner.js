                ...
                <div className="uk-width-1-1@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo text-center uk-align-center">
                      <h1>Website Hosting With <br/>Fast Performance </h1>
                      <p>Simple and reliable cloud web hosting solutions for your businesses and projects that lets you focus on things that really make a difference.</p>
