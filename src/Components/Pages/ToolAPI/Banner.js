...
class Banner extends React.Component {
    render() {
      return (
          ...
          style={{ backgroundImage: "url(/images/toolApiBanner.png)" }}
        >
                ...
                <div className="uk-width-1-2@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>Cloud APIs</h1>
                      <p>Cobolt’s API helps you manage Atoms and other resources on our cloud in a hassle-free manner using simple HTTP requests. Using APIs, not only you can streamline your next infrastructure project but also make changes in the code more swiftly.</p>
