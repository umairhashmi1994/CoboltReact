...
class Banner extends React.Component {
  render() {
    return (
      <div>
        <section
          className="HomeBannerTwo VpcBanner"
          style={{ backgroundImage: "url(/images/floatingIPBanner.png)" }}
        >
                  ...
                  <div className="uk-width-3-5@m uk-width-1-1@s">
                    <div className="mdl">
                      <div className="mdlinner bannertwo">
                        <h1>Skillfully Manage Your Traffic Using Floating IPs</h1>
                        <p>An IP address that can be moved from one Atom to another in the same datacenter, it effortlessly switches between servers and can be used to implement failovers</p>
