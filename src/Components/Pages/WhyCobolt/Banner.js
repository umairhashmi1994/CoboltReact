...
class Banner extends React.Component {
    render() {
      return (
          ...
          style={{ backgroundImage: "url(/images/whyCoboltBanner.png)" }}
        >
                ...
                <div className="uk-width-3-5@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>Indigenous Cloud Built For Developers</h1>
                      <p>Spend less time building and more time on creating magic </p>
