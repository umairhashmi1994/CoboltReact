...
class Banner extends React.Component {
    render() {
      return (
          <div>
              <section
          className="HomeBannerTwo analyticpadding"
          style={{ backgroundImage: "url(/images/AnalyticBanner.jpg)" }}
        >
                ...
                <div className="uk-width-3-5@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>Keep Your Data Secure And Accessible</h1>
                      <p>Store and process large volumes of data seamlessly using our developer-friendly cloud.</p>
