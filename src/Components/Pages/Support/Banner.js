...
class Banner extends React.Component {
    render() {
      return (
          ...
          style={{ backgroundImage: "url(/images/supportBanner.png)" }}
        >
                ...
                <div className="uk-width-3-5@m uk-width-1-1@s">
                  <div className="mdl">
                    <div className="mdlinner bannertwo">
                      <h1>Best In Class Support To Fuel Your Business</h1>
                      <p>Cobolt aims to help developers focus on testing their Ideas, building their businesses and spinning up magic that fuels their passion. </p>
